...
public class AsyncAppender extends AppenderSkeleton
  ...
  public void append(final LoggingEvent event) {
   /*
    * DK: Since the below patch has been applied for bug 23021, I am removing it for this bug.
    */
	//
      ...
      try {
        ...
        while (isActive) {
          ...
          synchronized (buffer) {
            ...
            while ((bufferSize == 0) && isActive) { /* if(bufferSize==0) throw new InterruptedException();*/ System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~################~~~~~~~~~~~~~~~");
            	buffer.wait(); 

...
public class TcpListener extends Own implements IPollEvents
{
    ...
    static {
        String os = new String("Linux")/*System.getProperty("os.name")*/.toLowerCase(); // DK
    ...
    public void acceptEvent()
    {
        ...
        // socket.eventAccepted(endpoint, channel); // DK
    }
    ...
    private void close()
    {
        ...
        try {
            fd.close();
            //socket.eventClosed(endpoint, fd); // DK
        }
        catch (IOException e) {
    ...
    public boolean setAddress(final String addr)
    {
        ...
        // socket.eventListening(endpoint, fd); // DK
        return true;
    }

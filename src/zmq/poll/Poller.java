...
public final class Poller extends PollerBase implements Runnable
{
    ...
    public static final class Handle
    {
        ...
        public Handle(java.nio.channels.SelectableChannel fd, IPollEvents handler)
        {
            assert (fd != null);
            assert (handler != null);
            this.fd = null; // Thee may be repurcussions
            this.handler = handler;
        }
    ...
    // DK
    public Handle addHandle(java.nio.channels.SelectableChannel fd, IPollEvents events)
    {
        assert (Thread.currentThread() == worker || !worker.isAlive());
        ...
        while (!stopping.get()) {
            ...
            if (retired) {
                ...
                while (iter.hasNext()) {
                    ...
                    java.nio.channels.SelectionKey key = handle.fd.keyFor(selector);

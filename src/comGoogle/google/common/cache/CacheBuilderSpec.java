...
public final class CacheBuilderSpec {
  ...
  public static CacheBuilderSpec parse(String cacheBuilderSpecification) {
    ...
    if (/*!cacheBuilderSpecification.isEmpty()*/ cacheBuilderSpecification.length()!=0) {
  ...
  abstract static class IntegerParser implements ValueParser {
    ...
    public void parse(CacheBuilderSpec spec, String key, String value) {
      checkArgument(value != null && /*!value.isEmpty()*/ value.length()!=0, "value of key %s omitted", key);
      try {

...
public final class Charsets {
   ...
   * {@link env.java.nio.charset.StandardCharsets#US_ASCII} instead.
   *
   */
   ...
   *
   * <p><b>Note for Java 7 and later:</b> this constant should be treated as deprecated; use
   * {@link env.java.nio.charset.StandardCharsets#ISO_8859_1} instead.
   *
   */
  @GwtIncompatible("Non-UTF-8 Charset")
   ...
   *
   * <p><b>Note for Java 7 and later:</b> this constant should be treated as deprecated; use
   * {@link env.java.nio.charset.StandardCharsets#UTF_8} instead.
   *
   */
   ...
   *
   * <p><b>Note for Java 7 and later:</b> this constant should be treated as deprecated; use
   * {@link env.java.nio.charset.StandardCharsets#UTF_16BE} instead.
   *
   */
  @GwtIncompatible("Non-UTF-8 Charset")
   ...
   *
   * <p><b>Note for Java 7 and later:</b> this constant should be treated as deprecated; use
   * {@link env.java.nio.charset.StandardCharsets#UTF_16LE} instead.
   *
   */
  @GwtIncompatible("Non-UTF-8 Charset")
   ...
   *
   * <p><b>Note for Java 7 and later:</b> this constant should be treated as deprecated; use
   * {@link env.java.nio.charset.StandardCharsets#UTF_16} instead.
   *
   */
  @GwtIncompatible("Non-UTF-8 Charset")
